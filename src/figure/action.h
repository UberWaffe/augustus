...
enum {
    ...
    FIGURE_ACTION_230_DEPOT_CART_PUSHER_INITIAL = 238,
    FIGURE_ACTION_231_DEPOT_CART_PUSHER_HEADING_TO_SOURCE = 239,
    FIGURE_ACTION_232_DEPOT_CART_PUSHER_AT_SOURCE = 240,
    FIGURE_ACTION_233_DEPOT_CART_HEADING_TO_DESTINATION = 241,
    FIGURE_ACTION_234_DEPOT_CART_PUSHER_AT_DESTINATION = 242,
    FIGURE_ACTION_235_DEPOT_CART_PUSHER_RETURNING = 243,
    FIGURE_ACTION_236_DEPOT_CART_PUSHER_CANCEL_ORDER = 244
};
