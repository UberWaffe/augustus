...
typedef enum {
    ...
    TR_PARAMETER_AFFECTS_LAND,
    TR_PARAMETER_AFFECTS_SEA,
    ...
    TR_ACTION_TYPE_CHANGE_SENTIMENT,
    TR_ACTION_TYPE_CHANGE_TRADE_MULTIPLIER,
    ...
    TR_PARAMETER_DOES_AFFECT_LAND,
    TR_PARAMETER_DOES_NOT_AFFECT_LAND,
    TR_PARAMETER_DOES_AFFECT_SEA,
    TR_PARAMETER_DOES_NOT_AFFECT_SEA,
    ...
    TR_EDITOR_LAND_TRADER_CARGO_PERCENTAGE,
    TR_EDITOR_SEA_TRADER_CARGO_PERCENTAGE,
