...
typedef enum {
    ...
    TR_ACTION_TYPE_TERRAIN_AREA_SET_TO,
    ...
    TR_PARAMETER_VALUE_ATTACK_TYPE_BARBARIAN,
    TR_PARAMETER_VALUE_ATTACK_TYPE_CAESAR,
    TR_PARAMETER_VALUE_ATTACK_TYPE_NATIVES,
    TR_PARAMETER_VALUE_ATTACK_TYPE_MARS_NATIVES,
    ...
    TR_PARAMETER_VALUE_TERRAIN_GRASS,
    TR_PARAMETER_VALUE_TERRAIN_TREE,
    TR_PARAMETER_VALUE_TERRAIN_ROCK,
    TR_PARAMETER_VALUE_TERRAIN_WATER,
    TR_PARAMETER_VALUE_TERRAIN_SHRUB,
    TR_PARAMETER_VALUE_TERRAIN_MEADOW,
    TR_PARAMETER_VALUE_TERRAIN_RUBBLE,
