...
static translation_string all_strings[] = {
    ...
    {TR_PARAMETER_AFFECTS_LAND, "Affects land traders?"},
    {TR_PARAMETER_AFFECTS_SEA, "Affects sea traders?"},
    ...
    {TR_ACTION_TYPE_CHANGE_TRADE_MULTIPLIER, "Change trade cargo max percentage" },
    ...
    {TR_PARAMETER_DOES_AFFECT_LAND, "affects land"},
    {TR_PARAMETER_DOES_NOT_AFFECT_LAND, "does not affect land"},
    {TR_PARAMETER_DOES_AFFECT_SEA, "affects sea"},
    {TR_PARAMETER_DOES_NOT_AFFECT_SEA, "does not affects sea"},
    ...
    {TR_EDITOR_LAND_TRADER_CARGO_PERCENTAGE, "Land trader max cargo %"},
    {TR_EDITOR_SEA_TRADER_CARGO_PERCENTAGE, "Sea trader max cargo %"},
